...
namespace Recipes_website.App_Code.Models
{
    public class Recipe
    {
        ...
        {
            string path = HttpContext.Current.Server.MapPath("./App_Data/Recipes.json");
        ...
        public static void saveRecipes(List<Recipe> recipes)
        {
            ...
            string recipesContent = javaScriptSerializer.Serialize(recipes);

            File.WriteAllText(path, recipesContent);
